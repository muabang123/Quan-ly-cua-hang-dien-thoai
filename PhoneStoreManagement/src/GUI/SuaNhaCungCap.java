...
public class SuaNhaCungCap extends javax.swing.JFrame {
    ...
    public SuaNhaCungCap(int ma,Main mainForm) {
       initComponents();
        this.ma = ma;
    ...
    NhaCungCapDTO sp = spBUS.getNhaCungCapById(ma);

    if (sp != null) {
        txtMa.setText(String.valueOf(sp.getMaNCC()));
        txtTen.setText(sp.getTenNCC());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
        ...
        // Cập nhật khách hàng
        boolean updatedKH = khBUS.suaNhaCungCap(kh);
