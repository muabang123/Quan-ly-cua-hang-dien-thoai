...
public class ThemNhaCungCap extends javax.swing.JFrame {
    ...
    public ThemNhaCungCap(Main mainForm) {
        initComponents();
    ...
    txtMa.setText("");  // Xóa trường Mã sản phẩm
    txtTen.setText("");  // Xóa trường Tên sản phẩm
    txtDiaChi.setText("");  // Xóa trường Đơn giá
    txtSDT.setText("");  // Xóa trường Chip
    txtEmail.setText("");  // Xóa trường Inch
}
